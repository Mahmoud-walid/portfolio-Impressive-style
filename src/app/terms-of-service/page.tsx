...
export const metadata: Metadata = {
  ...
  description: 'Professional Terms of Service for services by Mahmoud Walid.',
  alternates: { canonical: '/terms-of-service' },
  openGraph: {
    title: 'Terms of Service | Mahmoud Walid',
    description:
...
export default function TermsOfServicePage() {
  return (
    <PolicyPageClient
      ...
      intro="These Terms of Service govern access to mahmoudwalid.com and all consulting, engineering, automation, and product delivery services provided by Mahmoud Walid."
      sections={[
        {
          title: 'Service Scope',
          content: [
        ...
        },
        {
          ...
          content: [
            'Questions regarding these terms can be sent to contact@mahmoudwalid.com.',
