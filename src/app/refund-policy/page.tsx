...
export const metadata: Metadata = {
  title: 'Refund Policy',
  description: 'Refund terms for services provided by Mahmoud Walid.',
  alternates: { canonical: '/refund-policy' },
  openGraph: {
    title: 'Refund Policy | Mahmoud Walid',
    description:
...
export default function RefundPolicyPage() {
  return (
    <PolicyPageClient
      ...
      intro="This Refund Policy applies to services delivered by Mahmoud Walid through mahmoudwalid.com and direct client agreements."
      sections={[
        {
        ...
        },
        {
          ...
          content: [
            'Refund requests must be sent in writing to contact@mahmoudwalid.com with invoice details and a clear reason.',
