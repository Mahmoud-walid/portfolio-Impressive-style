...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for mahmoudwalid.com services and communications.',
  alternates: { canonical: '/privacy-policy' },
  openGraph: {
    title: 'Privacy Policy | Mahmoud Walid',
    description:
      'How data is collected, used, and protected on mahmoudwalid.com.',
...
export default function PrivacyPolicyPage() {
  return (
    <PolicyPageClient
      ...
      intro="This Privacy Policy explains how Mahmoud Walid collects, uses, and protects information when you use mahmoudwalid.com and related services."
      sections={[
        {
        ...
        },
        {
          ...
          content: [
            ...
            'For privacy questions, contact: contact@mahmoudwalid.com.',
          ],
        },
      ]}
    />
