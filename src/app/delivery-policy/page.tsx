...
export const metadata: Metadata = {
  ...
  description: 'Delivery standards and channels for services by Mahmoud Walid.',
  alternates: { canonical: '/delivery-policy' },
  openGraph: {
    title: 'Delivery Policy | Mahmoud Walid',
...
export default function DeliveryPolicyPage() {
  return (
    <PolicyPageClient
      ...
      intro="This Delivery Policy describes how services and project deliverables are provided by Mahmoud Walid through remote-first workflows."
      sections={[
        {
          title: 'Delivery Mode',
          content: [
