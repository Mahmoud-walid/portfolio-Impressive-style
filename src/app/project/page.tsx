...
export const metadata: Metadata = {
  title: 'Projects',
  description:
    'SSR-fetched GitHub projects by Mahmoud Walid with filtering and search.',
  alternates: {
    canonical: '/project',
  },
  keywords: [
  ...
  openGraph: {
    title: 'Projects by Mahmoud Walid',
    description:
...
export default async function ProjectPage() {
  ...
  const projectsJsonLd = {
    ...
    '@type': 'CollectionPage',
    name: 'Projects by Mahmoud Walid',
    url: `${siteUrl}/project`,
