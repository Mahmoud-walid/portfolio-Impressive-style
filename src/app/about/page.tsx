...
import { devUrl, githubUrl, siteUrl } from '@/lib/site-config';

const aboutOgImageUrl = `${siteUrl}/about/opengraph-image`;

export const metadata: Metadata = {
  title: 'About',
  description: 'The journey, roles, and milestones of Mahmoud Walid.',
  alternates: {
    canonical: '/about',
  },
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Journey, milestones, and experience across frontend, open source, and AI delivery.',
    url: `${siteUrl}/about`,
    type: 'profile',
    images: [
      {
...
const timelineItems: TimelineItem[] = [
  {
    ...
    title: 'Founder (Mahmoud Walid Technologies · Full-time)',
    url: devUrl,
    description:
...
export default function AboutPage() {
  const aboutJsonLd = {
    ...
    mainEntity: {
      ...
      url: siteUrl,
      jobTitle:
        'frontend engineer, open source contributor, and full stack developer',
    },
  };
